...
<body>
	...
	<section class="hero">
		<div class="container hero-inner">
			...
			<h2>
				필요한 도움을 올리면<br> 가까운 이웃이 지원합니다
			</h2>

			<p class="hero-desc">
				청소, 과외, 펫시터, 짐 옮기기, 간단 수리까지<br> 우리 동네에서 필요한 도움을 요청하고 매칭해보세요.
			</p>
	...
	<section class="category-section">
		<div class="container">
			<div class="category-list">
				<a href="#" class="active">전체</a> <a href="#">청소</a> <a href="#">펫시터</a>
				<a href="#">과외</a> <a href="#">짐 옮기기</a> <a href="#">수리</a> <a
					href="#">직접입력</a>
			</div>
		</div>
	</section>
						...
						<article class="post-card">
							<a href="${helpPostDetail}"
								...
								<div class="post-content">
									<div class="post-top">
										<span class="status open"> ${helpPost.postStatus} </span> <span
											class="location"> ${helpPost.postAddrGu}
											${helpPost.postAddrDong} </span>
									</div>
